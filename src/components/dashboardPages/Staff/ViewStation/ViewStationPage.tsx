...
const ViewStationPage = ({ stationId }: { stationId: string }) => {
  const { isError, isLoading, data } = useGetStaffStationQuery(stationId, {
        ...
        <div className="mb-5 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">
              {station.staffs.length} staff assigned to this station
            </p>
          </div>
...
export default ViewStationPage;
