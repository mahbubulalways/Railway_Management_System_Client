        ...
        {staffs.map((staff) => (
          ...
          >
            ...
            <div className="space-y-4 p-5">
              ...
              <Link href={`view-staff/${staff.staffId}`}>
                <button className="mt-2 w-full rounded-xl bg-[#006A4E] px-4 py-3 text-sm font-medium text-white transition hover:bg-[#00553e] cursor-pointer">
                  View Details
                </button>
              </Link>
            </div>
